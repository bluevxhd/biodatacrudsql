...
<html>
<head>
    <title>Formulir Edit Siswa | SMA Diakonia</title>
</head>
...
<body>
    ...
    <form action="proses-edit.php" method="POST">
        ...
        <p>
            ...
            <input type="text" name="ttl" value="<?php echo $siswa['ttl'] ?>" required />
        </p>
        <p>
            <label for="umur">Umur: </label>
            <input type="number" name="umur" value="<?php echo $siswa['umur'] ?>" required />
        </p>
        <p>
